...
public class CertificateResource {
  ...
  public Response createCertificate(CertificateDto certificate) {
    try {
      ...
      return ResponseBuilder.buildSuccessResponse(
          "Certificate created successfully", null, Response.Status.CREATED);
  ...
  public Response getAllCertificates() {
    try {
      ...
      return ResponseBuilder.buildSuccessResponse(
          "Certificate retrieved successfully", allCertificates, Response.Status.CREATED);
    } catch (EntityNotFoundException e) {
      return ResponseBuilder.buildErrorResponse(e.getMessage(), Response.Status.NOT_FOUND);
    } catch (Exception e) {
      return ResponseBuilder.buildErrorResponse(
  ...
  public Response getCertificateById(@PathParam("id") Long id) {
    try {
      ...
      return ResponseBuilder.buildSuccessResponse(
          "Certificate retrieved successfully", certificateDto, Response.Status.OK);
    } catch (EntityNotFoundException e) {
      return ResponseBuilder.buildErrorResponse(e.getMessage(), Response.Status.NOT_FOUND);
    } catch (Exception e) {
      return ResponseBuilder.buildErrorResponse(
  ...
  public Response updateCertificate(@PathParam("id") Long id, CertificateDto certificateDto) {
    try {
      ...
      return ResponseBuilder.buildSuccessResponse(
          "Certificate updated successfully", updatedCertificate, Response.Status.OK);
    } catch (EntityNotFoundException e) {
      return ResponseBuilder.buildErrorResponse(e.getMessage(), Response.Status.NOT_FOUND);
    } catch (Exception e) {
  ...
  public Response deleteCertificateById(@PathParam("id") Long id) {
    try {
      ...
      return ResponseBuilder.buildSuccessResponse(
          "Certificate deleted successfully", null, Response.Status.OK);
    } catch (EntityNotFoundException e) {
      return ResponseBuilder.buildErrorResponse(e.getMessage(), Response.Status.NOT_FOUND);
    } catch (Exception e) {
      return ResponseBuilder.buildErrorResponse(
